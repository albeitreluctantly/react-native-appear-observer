...
import { InteractionHandlers, InteractionRecorders, ObservableElementProps } from '../utils';
export interface AppearObserverProviderProps extends InteractionHandlers, ObservableElementProps {
    readonly ref?: AnyElementRef;
    readonly enableInteractionMode?: boolean;
    readonly children: ReactNode | ((props: InteractionHandlers & ObservableElementProps, interactionRecorders: InteractionRecorders) => ReactNode);
